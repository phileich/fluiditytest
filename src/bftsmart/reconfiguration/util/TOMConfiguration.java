...
public class TOMConfiguration extends Configuration {
	...
	protected void init() {
		...
		try {
			...
			if (useFluidity && fluidityDistributionStrategy.equals("Weight Graph Distribution")) {
	...
	/**
	 * Indicates if signatures should be used (1) or not (0) to authenticate
	 * client requests
	 */
	...
	/**
	 * Indicates if MACs should be used (1) or not (0) to authenticate
