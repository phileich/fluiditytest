...
public  class TOMLayer extends Thread implements RequestReceiver {
    ...
    protected ServerCommunicationSystem communication; // Communication system between replicas
    ...
    protected ReentrantLock leaderLock = new ReentrantLock();
    protected Condition iAmLeader = leaderLock.newCondition();
    protected ReentrantLock messagesLock = new ReentrantLock();
    protected Condition haveMessages = messagesLock.newCondition();
    protected ReentrantLock proposeLock = new ReentrantLock();
    protected Condition canPropose = proposeLock.newCondition();
    ...
    protected Synchronizer syncher;
