...
//	private long dynamicWeightTimestamp = -1; // the timestamp used for server
	// to server time measurement
	...
	/**
	 * Creates a consensus message. Used by the message factory to create a
	 * COLLECT or PROPOSE message TODO: How about removing the modifier, to make
	 * it visible just within the package?
	 * 
	 * @param paxosType
	 *            This should be MessageFactory.COLLECT or
	...
	/**
	 * Creates a consensus message. Used by the message factory to create a
	 * FREEZE message TODO: How about removing the modifier, to make it visible
	 * just within the package?
	 * 
	 * @param type
	 *            This should be MessageFactory.FREEZE
	 * @param id
	 *            Consensus's consensus ID
	 * @param epoch
	 *            Epoch timestamp
	 * @param from
	 *            This should be this process ID
...
//		dynamicWeightTimestamp = in.readLong();
	...
	public String getPaxosVerboseType() {
		...
		else if (paxosType == MessageFactory.WRITE_RESPONSE)
