 ...
 *
 */
public class HashLatencyClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<numThreads; i++) {
            try {
                ...
                Logger.getLogger(HashLatencyClient.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            System.out.println("Launching client " + (initId+i));
            c[i] = new HashLatencyClient.Client(initId+i,numberOfOps,requestSize,interval,readOnly, verbose, dos);
            //c[i].start();
        }
